...
## CRAFT说明
 ...
 本项目旨在使用CRAFT方法训练中文场景下的文字检测器，其中[CRAFT官方项目](https://github.com/clovaai/CRAFT-pytorch)，这里我们训练程序参考[CRAFT_keras](https://github.com/RubanSeven/CRAFT_keras)，对原始训练程序一部分进行修改并进行对比实验。
