...
class SynthTextConvertor:
    ...
    def __load_mat(self):
        ...
        print('word_boxes_list',type(word_boxes_list))
        print('word_boxes_list',word_boxes_list[0])
        print('char_boxes_list',type(char_boxes_list))
        print('char_boxes_list',char_boxes_list[0])
...
if __name__ == '__main__':
    ...
    synth_text_convertor = SynthTextConvertor(mat_path=r'/home/ldf/aster/data/SynthText/gt.mat',
                                              image_root=r'/home/ldf/aster/data/SynthText')
    craft_sample_list = synth_text_convertor.convert_to_craft()
    np.random.shuffle(craft_sample_list)
    with open(r'/home/ldf/CRAFT_keras/data/SynthText/gt.pkl', 'wb') as pkl_file:
